...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x4A, 0x47, 0xCB, 0xC9, 0xD5, 0x68, 0xD7, 0x58, 0xC0, 0x4D, 0xD9, 0xCF, 0x24, 0x3A, 0x78, 0x15,
        0xF6, 0xDD, 0xF0, 0xBC, 0x72, 0x1B, 0x84, 0xC8, 0x24, 0xED, 0xBC, 0xA1, 0x6D, 0x66, 0x7F, 0xC3,
    };
